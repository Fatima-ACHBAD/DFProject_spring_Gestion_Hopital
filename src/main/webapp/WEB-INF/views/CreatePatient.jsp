...
<main>
    ...
    <form action="savePatient" method="post">
        <div>
            ...
            <input class="form-control" type="text" id="namePatient" name="nom">
        </div>
        <div>
            <label for="dateBirth">Birth : </label>
            <input class="form-control" type="date" id="dateBirth" name="dateNaissance" value="${now}">
        </div>
        <div>
            <label for="adressPatient">Adress : </label>
            <input class="form-control" type="text" id="adressPatient" name="adresse">
        </div>
        <div>
        ...
        <div>
            ...
            <input class="form-control" type="text" id="phonePatient" name="numeroTelephone">
        </div>
        <div>
            <label for="sicknessPatient">Sickness : </label>
            <input type="checkbox" id="sicknessPatient" name="malade">
        </div>
